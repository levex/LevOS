...
extern uint8_t pic_read_data (uint8_t picNum);

// Send a data byte to pic
extern void pic_send_data (uint8_t data, uint8_t picNum);

// Send operational command to pic
extern void pic_send_command (uint8_t cmd, uint8_t picNum);

// Enables and disables interrupts
extern void pic_mask_irq (uint8_t irqmask, uint8_t picNum);

// Initialize pic
extern bool pic_initialize (uint8_t base0, uint8_t base1);
#endif
