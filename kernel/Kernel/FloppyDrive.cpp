...
void flpydsk_send_command (uint8_t cmd) {
	...
	for (int i = 0; i < 500; i++ )
		if ( flpydsk_read_status () & FLPYDSK_MSR_MASK_DATAREG )
			return outport (FLPYDSK_FIFO, cmd);
}
