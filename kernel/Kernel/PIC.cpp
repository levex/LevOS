...
inline void pic_send_command (uint8_t cmd, uint8_t picNum) {
...
// send data to PICs
inline void pic_send_data (uint8_t data, uint8_t picNum) {
...
// read data from PICs
inline uint8_t pic_read_data (uint8_t picNum) {
...
// Initialize pic
bool pic_initialize (uint8_t base0, uint8_t base1) {
